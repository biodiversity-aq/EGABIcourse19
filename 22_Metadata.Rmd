...
* [Darwin Core Structure](### Darwin Core structure)
* [Types of Darwin Core Archives] (### Types of Darwin Core Archives)
...
the meta.xml describes how the files in the archive are organised. It describes the linkage between the core and extension files and maps non-standards column names to Darwin Core terms.
...
If you use the IPT to create your Darwin Core archive. you will have to choose a shortname for your dataset. Choose this wisely because it can't be changed. The short name serves as an identifier within the IPT installation, and will be used as a parameter in the URL to access the resource via the Internet.
