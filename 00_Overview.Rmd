...
```{r predmap3}
plot(basemap)
SOplot(pr, col = my_cmap, legend = FALSE,
       breaks = seq(0, 0.9, length.out = length(my_cmap) + 1))
## curved legend
SOleg(position = "bottomleft", col = my_cmap,
      breaks = seq(0, 0.9, by = 0.15),
      type = "continuous", label = "Probability")
## placename points
